...
void solution()
{
    ...
    while (A.size() == 0 && B.size() && AB.size() && k)
    {
        int both = AB.top();
        int as = 0;
        int bob = B.top();
    ...
    while (A.size() && B.size() == 0 && AB.size() && k)
    {
        int both = AB.top();
        int as = A.top();
        int bob = 0;
    ...
    while (A.size() == 0 && B.size() == 0 && AB.size() && k)
    {
        int both = AB.top();
        k--;
        ans += both;
    ...
    while (A.size() && B.size() && AB.size() == 0 && k)
    {
        int as = A.top();
        int bob = B.top();
        k--;
